...
if (keyboard_check_pressed(vk_space)) {
	with (new UIPanel("Panel1", 20, 20, 400, 600, blue_panel)) {
		with (add(new UIButton("Button1", 25, 15, 200, 50, "[fnt_Test][fa_center][fa_middle][col_white]Hello World", blue_button00))) {
	...
	with (new UIPanel("Panel2", 200, 90, 300, 500, green_panel)) {
		add(new UIButton("Button2", 25, 15, 200, 50, "[fnt_Test][fa_center][fa_middle][col_white]Bye", green_button00));
	}
